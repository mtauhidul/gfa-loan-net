                        ...
                        <ul className="form-section page-section">
                            <li id="cid_1" className="form-input-wide" data-type="control_head">
                                <div className="form-header-group header-large">
                                    <div className="header-text httal htvam">
                                        ...
                                        >
                                            Payroll Protection Program Round 2 Application
                                        </h1>
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_82"
                                >
                                    Agent Ref ID <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_82"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_3"
                                >
                                    Applying as <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_3"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_95"
                                >
                                    Purpose of the Loan <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_95"
                                    className="form-input jf-required"
                                ...
                                >
                                    ...
                                    >
                                        <span className="form-checkbox-item">
                                            ...
                                            />
                                            <label id="label_input_95_0" htmlFor="input_95_0">
                                                Payroll
                                            </label>
                                        </span>
                                        <span className="form-checkbox-item">
                                            ...
                                            <input
                                                ...
                                                id="input_95_1"
                                                name="Purpose of Loan"
                                                defaultValue="Rent/Mortgage Interest"
                                            />
                                            <label id="label_input_95_1" htmlFor="input_95_1">
                                        ...
                                        >
                                            ...
                                            />
                                            <label id="label_input_95_2" htmlFor="input_95_2">
                                                Utilities
                                            </label>
                                        </span>
                                        <span className="form-checkbox-item">
                                            ...
                                            <input
                                                ...
                                                id="input_95_3"
                                                name="Purpose of Loan"
                                                defaultValue="Covered Property Damage"
                                            />
                                            <label id="label_input_95_3" htmlFor="input_95_3">
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                id="input_95_4"
                                                name="Purpose of Loan"
                                                defaultValue="Covered Supplier Costs"
                                            />
                                            <label id="label_input_95_4" htmlFor="input_95_4">
                                        ...
                                        <span className="form-checkbox-item">
                                            ...
                                            <input
                                                ...
                                                id="input_95_5"
                                                name="Purpose of Loan"
                                                defaultValue="Covered Worker Protection Expenditures"
                                            />
                                            <label id="label_input_95_5" htmlFor="input_95_5">
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                id="input_95_6"
                                                name="Purpose of Loan"
                                                defaultValue="Covered Operations Expenditures"
                                            />
                                            <label id="label_input_95_6" htmlFor="input_95_6">
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_80"
                                >
                                    Business Legal Name <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_80"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_5"
                                >
                                    E-mail Address <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_5"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_82"
                                >
                                    Federal Tax ID <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_82"
                                    className="form-input jf-required"
                            ...
                            >
                                ...
                                >
                                    Business Phone <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_8"
                                    className="form-input jf-required"
                            ...
                            >
                                ...
                                >
                                    Business Address <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_9"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_54"
                                >
                                    How much funding did you receive from PPP Round 1
                                    <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_54"
                                ...
                                >
                                    <select
                                        ...
                                        className="form-dropdown validate[required]"
                                        id="input_54"
                                        name="Funding from PPP1"
                                        style={{ width: 310 }}
                                        data-component="dropdown"
                                        required
                                        aria-labelledby="label_54"
                                    >
                                        <option onBlur={handleChange} value>
                                            Please Select
                                        </option>
                                        <option onBlur={handleChange} value="Didn't Apply">
                                            Didn't Apply
                                        </option>
                                        <option
                                            onBlur={handleChange}
                                            value="Applied but didn't receive funding"
                                        >
                                            Applied but didn't receive funding
                                        </option>
                                        <option onBlur={handleChange} value="$0-$50,000">
                                            $0-$50,000
                                        </option>
                                        <option onBlur={handleChange} value="$50,000-$100,000">
                                            $50,000-$100,000
                                        ...
                                        <option onBlur={handleChange} value="$500,000-$1,000,000">
                                            $500,000-$1,000,000
                                        </option>
                                        <option onBlur={handleChange} value="$1,000,000-$2,000,000">
                                            $1,000,000-$2,000,000
                                        </option>
                                        <option onBlur={handleChange} value="$2,000,000+">
                                            $2,000,000+
                                        </option>
                                    </select>
                                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    accounts? <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_59"
                                    className="form-input jf-required"
                            ...
                            >
                                ...
                                >
                                    ...
                                    bankruptcy? <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_47"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_48"
                                >
                                    Has the Applicant or any owner defaulted in the last 7 years and
                                    ...
                                    >
                                        <span className="form-radio-item">
                                            ...
                                            <input
                                                ...
                                                className="form-radio validate[required]"
                                                id="input_48_0"
                                                name="Default in last 7 years"
                                                defaultValue="Yes"
                                                required
                                            />
                                            <label id="label_input_48_0" htmlFor="input_48_0">
                                                {' '}
                                                Yes{' '}
                                            </label>
                                        </span>
                                        <span className="form-radio-item">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <label id="label_input_48_1" htmlFor="input_48_1">
                                                {' '}
                                                No{' '}
                                            </label>
                                        </span>
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_49"
                                >
                                    Is the Applicant or any owner of the Applicant an owner of any
                                    other business? <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_49"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_50"
                                >
                                    Has the Applicant received an SBA Economic Injury Disaster Loan
                                    between Jan. 31,2020 and Apr. 31, 2020?
                                    <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_50"
                                    ...
                                    >
                                        <span className="form-radio-item">
                                            ...
                                            <input
                                                ...
                                                className="form-radio validate[required]"
                                                id="input_50_0"
                                                name="SBA Diaster Loan"
                                                defaultValue="Yes"
                                                required
                                            />
                                            <label id="label_input_50_0" htmlFor="input_50_0">
                                                {' '}
                                                Yes{' '}
                                            </label>
                                        </span>
                                        <span className="form-radio-item">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <label id="label_input_50_1" htmlFor="input_50_1">
                                                {' '}
                                                No{' '}
                                            </label>
                                        </span>
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_83"
                                >
                                    Ownership% <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_83"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_86"
                                >
                                    SSN <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_86"
                                    className="form-input jf-required"
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_87"
                                >
                                    FICO <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_87"
                                    className="form-input jf-required"
                            ...
                            >
                                ...
                                >
                                    Owner Phone Number <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_104"
                                    className="form-input jf-required"
                            ...
                            <li className="form-line" data-type="control_text" id="id_98">
                                <div id="cid_98" className="form-input-wide" data-layout="full">
                                    <div id="text_98" className="form-html" data-component="text">
                                        <p>Partner Information</p>
                                    </div>
                                </div>
                            </li>
                            <li className="form-line" data-type="control_fullname" id="id_99">
                                <label
                                    className="form-label form-label-left form-label-auto"
                                    id="label_99"
                                    htmlFor="first_99"
                                ...
                                <div id="cid_99" className="form-input" data-layout="full">
                                    <div data-wrapper-react="true">
                                        <span
                                            className="form-sub-label-container"
                                            style={{ verticalAlign: 'top' }}
                                        ...
                                        >
                                            <input
                                                ...
                                                size={10}
                                                data-component="first"
                                                aria-labelledby="label_99 sublabel_99_first"
                                            />
                                            <label
                                                className="form-sub-label"
                                                htmlFor="first_99"
                                                id="sublabel_99_first"
                                                style={{ minHeight: 13 }}
                                                aria-hidden="false"
                                            >
                                                First Name
                                        ...
                                        >
                                            <input
                                                ...
                                                size={15}
                                                data-component="last"
                                                aria-labelledby="label_99 sublabel_99_last"
                                            />
                                            <label
                                                className="form-sub-label"
                                                htmlFor="last_99"
                            ...
                            <li className="form-line" data-type="control_textbox" id="id_100">
                                <label
                                    className="form-label form-label-left form-label-auto"
                                    id="label_100"
                                    htmlFor="input_100"
                                ...
                                <div id="cid_100" className="form-input" data-layout="half">
                                    <input
                                        onChange={handleChange}
                                        type="text"
                                        id="input_100"
                            ...
                            <li className="form-line" data-type="control_number" id="id_101">
                                <label
                                    className="form-label form-label-left"
                                    id="label_101"
                                    htmlFor="input_101"
                                ...
                                <div id="cid_101" className="form-input" data-layout="half">
                                    <input
                                        onChange={handleChange}
                                        type="number"
                                        id="input_101"
                            ...
                            <li className="form-line" data-type="control_number" id="id_102">
                                <label
                                    className="form-label form-label-left form-label-auto"
                                    id="label_102"
                                    htmlFor="input_102"
                                ...
                                <div id="cid_102" className="form-input" data-layout="half">
                                    <input
                                        onChange={handleChange}
                                        type="number"
                                        id="input_102"
                                        ...
                                        size={310}
                                        data-component="number"
                                        aria-labelledby="label_102"
                                        step="any"
                                    />
                                </div>
                            </li>
                            <li className="form-line" data-type="control_phone" id="id_105">
                                <label
                                    className="form-label form-label-left form-label-auto"
                                    id="label_105"
                                    htmlFor="input_105_full"
                                >
                                    Partner Phone Number
                                </label>
                                <div id="cid_105" className="form-input" data-layout="half">
                                    <span
                                        className="form-sub-label-container"
                                        style={{ verticalAlign: 'top' }}
                                    >
                                        <input
                                            ...
                                            placeholder="(000) 000-0000"
                                            data-component="phone"
                                            aria-labelledby="label_105 sublabel_105_masked"
                                        />
                                        <label
                                            className="form-sub-label"
                                            htmlFor="input_105_full"
                                            id="sublabel_105_masked"
                                            style={{ minHeight: 13 }}
                                            aria-hidden="false"
                                        >
                                            Please enter a valid phone number.
                            ...
                            <li className="form-line" data-type="control_datetime" id="id_103">
                                <label
                                    className="form-label form-label-left form-label-auto"
                                    id="label_103"
                                    htmlFor="lite_mode_103"
                                >
                                    Date of Birth of Partner:
                                </label>
                                <div id="cid_103" className="form-input" data-layout="half">
                                    <div data-wrapper-react="true">
                                        <span
                                            className="form-sub-label-container"
                                            style={{ verticalAlign: 'top' }}
                                        >
                                            <input
                                                ...
                                                type="date"
                                                name="Partner birth"
                                                className="form-textbox validate[limitDate, validateLiteDate]"
                                                id="lite_mode_103"
                                                size={12}
                                                data-maxlength={12}
                                                maxLength={12}
                                                ...
                                                placeholder="MM-DD-YYYY"
                                                autoComplete="off"
                                                aria-labelledby="label_103 sublabel_103_litemode"
                                            />
                                            <label
                                                className="form-sub-label"
                                                htmlFor="lite_mode_103"
                                                id="sublabel_103_litemode"
                                                style={{ minHeight: 13 }}
                                                aria-hidden="false"
                                            >
                                                Date
                                    ...
                                    >
                                        <span className="form-radio-item">
                                            ...
                                            <input
                                                ...
                                                className="form-radio validate[required]"
                                                id="input_76_0"
                                                name="Want to process loan"
                                                defaultValue="Yes"
                                                required
                                            />
                                            <label id="label_input_76_0" htmlFor="input_76_0">
                                                {' '}
                                                Yes{' '}
                                            </label>
                                        </span>
                                        <span className="form-radio-item">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <label id="label_input_76_1" htmlFor="input_76_1">
                                                {' '}
                                                No{' '}
                                            </label>
                                        </span>
                            ...
                            <li className="form-line" data-type="control_text" id="id_75">
                                <div id="cid_75" className="form-input-wide" data-layout="full">
                                    <div id="text_75" className="form-html" data-component="text">
                                        <p>
                                            Upload your last six months bank statements and photo ID
                                            below
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li className="form-line" data-type="control_number" id="id_92">
                                <label
                                    className="form-label form-label-left form-label-auto"
                                    id="label_92"
                                    htmlFor="input_92"
                                ...
                                <div id="cid_92" className="form-input" data-layout="half">
                                    <span
                                        className="form-sub-label-container"
                                        style={{ verticalAlign: 'top' }}
                                    >
                                        <input
                                            ...
                                            size={310}
                                            data-component="number"
                                            aria-labelledby="label_92 sublabel_input_92"
                                            step="any"
                                        />
                                        <label
                                            className="form-sub-label"
                                            htmlFor="input_92"
                                            id="sublabel_input_92"
                                            style={{ minHeight: 13 }}
                                            aria-hidden="false"
                                        >
                                            Put the Promotion Code if you have one
                                        </label>
                                    </span>
                                </div>
                            </li>
                            ...
                            >
                                <label
                                    ...
                                    htmlFor="input_90"
                                >
                                    How do you know us? <span className="form-required"> * </span>
                                </label>
                                <div
                                    id="cid_90"
                                    className="form-input jf-required"
                            ...
                            <li className="form-line" data-type="control_text" id="id_111">
                                <div id="cid_111" className="form-input-wide" data-layout="full">
                                    ...
                                    >
                                        ...
                                        \u201cyou\u201d) authorize Loan-Acc LLC (\u201cLoan-Acc
                                        Network\u201d) and each of its representatives, successors,
                                        assigns and designees (\u201cRecipients\u201d) that may be
                                        involved with or acquire commercial loans having daily
                                        repayment features or purchases of future receivables
                                        including Merchant Cash Advance transactions, including
                                        without limitation the application therefor (collectively,
                                        \u201cTransactions\u201d) to obtain consumer or personal,
                                        business and investigative reports and other information
                                        about you, including credit card processor statements and
                                        bank statements, from one or more consumer reporting
                                        agencies, such as TransUnion, Experian and Equifax, and from
                                        other credit bureaus, banks, creditors and other third
                                        parties. You also authorize Loan-Acc Network to transmit
                                        this application form, along with any of the foregoing
                                        information obtained in connection with this application, to
                                        any or all of the Recipients for the foregoing purposes. You
                                        also consent to the release, by any creditor or financial
                                        institution, of any information relating to any of you, to
                                        Loan-Acc Network and to each of the Recipients, on its own
                                        behalf. You also authorize Loan-Acc Network and each of its
                                        Recipients to contact you via text message, automated call
                                        or email message at the contact information listed above.
                                    </div>
                                </div>
                            </li>
                            <li
